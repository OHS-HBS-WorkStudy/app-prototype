  ...
  const handleMouseLeave = () => {
    ...
    return (
        <div>
            ...
            <button className={`nav-toggle ${isExpanded ? 'menu-open' : ''}`} onClick={switchToggle}>

            <div className={`nav-toggle-open ${isExpanded ? '' : 'opensvg'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                <path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/>
              </svg>
            </div>

            <div className={`nav-toggle-close ${isExpanded ? 'closesvg' : ''}`}>
        ...
        <nav className="sidebar">
          ...
          {/* <button onClick={toggleDarkMode}>Butttttton</button>*/}
                    ...
                    <div className="menu-items">
                            ...
                            <button className="nav-btn" onClick={SignUp}>
                            ...
                            <button className="nav-btn" onClick={Login}>
                              ...
                              <div className="circle-link">
                            <button className="nav-btn" onClick={HomePage}>
                            <i><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" className="icon-home">
                <path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/>
                              ...
                              <div className="circle-link">
                            <button className="nav-btn" onClick={NewThread}>
                                
                                <i><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" className="icon-pencil">
                <path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/>
                              ...
                              <div className="circle-link">
                            <button className="nav-btn" onClick={AccountPage}>
